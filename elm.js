...
var _ohanhi$elm_native_ui$App_Types$Speaker = F3(
	function (a, b, c) {
		return {name: a, bio: b, image: c};
	});
var _ohanhi$elm_native_ui$App_Types$Talk = F5(
	function (a, b, c, d, e) {
		return {title: a, speaker: b, description: c, start: d, duration: e};
	});
var _ohanhi$elm_native_ui$App_Types$BreakTime = F3(
	function (a, b, c) {
		return {title: a, start: b, duration: c};
	});
var _ohanhi$elm_native_ui$App_Types$Model = function (a) {
	return {activities: a};
};
var _ohanhi$elm_native_ui$App_Types$BreakTimeActivity = function (a) {
	return {ctor: 'BreakTimeActivity', _0: a};
};
var _ohanhi$elm_native_ui$App_Types$TalkActivity = function (a) {
	return {ctor: 'TalkActivity', _0: a};
};
var _ohanhi$elm_native_ui$App_Types$ScheduleResponse = function (a) {
	return {ctor: 'ScheduleResponse', _0: a};
};
var _ohanhi$elm_native_ui$App_Types$LoadSchedule = {ctor: 'LoadSchedule'};

var _ohanhi$elm_native_ui$App_Rest$decodeSpeaker = A3(
	...
	A3(
		...
		A3(
			...
			'name',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_ohanhi$elm_native_ui$App_Types$Speaker))));
var _ohanhi$elm_native_ui$App_Rest$date = function () {
...
var _ohanhi$elm_native_ui$App_Rest$decodeTalk = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'duration',
	...
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'starts',
		_ohanhi$elm_native_ui$App_Rest$date,
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'description',
			_elm_lang$core$Json_Decode$string,
			A3(
				_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
				'speaker',
				_ohanhi$elm_native_ui$App_Rest$decodeSpeaker,
				A3(
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
					'title',
					_elm_lang$core$Json_Decode$string,
					_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_ohanhi$elm_native_ui$App_Types$Talk))))));
var _ohanhi$elm_native_ui$App_Rest$decodeBreakTime = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'duration',
	_elm_lang$core$Json_Decode$int,
	A3(
		...
		A3(
			...
			'title',
			_elm_lang$core$Json_Decode$string,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_ohanhi$elm_native_ui$App_Types$BreakTime))));
var _ohanhi$elm_native_ui$App_Rest$decodeActivity = _elm_lang$core$Json_Decode$oneOf(
	{
		ctor: '::',
		_0: A2(
			_elm_lang$core$Json_Decode$andThen,
			function (x) {
				return _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(
					_ohanhi$elm_native_ui$App_Types$TalkActivity(x));
			},
			_ohanhi$elm_native_ui$App_Rest$decodeTalk),
		_1: {
			ctor: '::',
			_0: A2(
				_elm_lang$core$Json_Decode$andThen,
				function (x) {
					return _NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(
						_ohanhi$elm_native_ui$App_Types$BreakTimeActivity(x));
				},
				_ohanhi$elm_native_ui$App_Rest$decodeBreakTime),
			_1: {ctor: '[]'}
		}
	});
var _ohanhi$elm_native_ui$App_Rest$getScheduleCmd = A2(
	_elm_lang$core$Platform_Cmd$map,
	_ohanhi$elm_native_ui$App_Types$ScheduleResponse,
	_krisajenkins$remotedata$RemoteData$sendRequest(
		A2(
			_elm_lang$http$Http$get,
			'https://elmeurope-api-nwhllijofa.now.sh/schedule',
			_elm_lang$core$Json_Decode$list(_ohanhi$elm_native_ui$App_Rest$decodeActivity))));

var _ohanhi$elm_native_ui$App_State$update = F2(
	function (msg, model) {
		var _p0 = msg;
		if (_p0.ctor === 'ScheduleResponse') {
			return {
				ctor: '_Tuple2',
...
var _ohanhi$elm_native_ui$NativeUi_Properties$underlayColor = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'underlayColor',
		_elm_lang$core$Json_Encode$string(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$statusBarHeight = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'statusBarHeight',
		_elm_lang$core$Json_Encode$float(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$enableGestures = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'enableGestures',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$gestureResponseDistance = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'gestureResponseDistance',
		_elm_lang$core$Json_Encode$float(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$activeOpacity = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'activeOpacity',
		_elm_lang$core$Json_Encode$float(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$itemPositioning = function (val) {
	...
	return A2(_ohanhi$elm_native_ui$NativeUi$property, 'itemPositioning', jsonValue);
};
var _ohanhi$elm_native_ui$NativeUi_Properties$showHideTransition = function (val) {
	var stringValue = function () {
		var _p1 = val;
	...
	var jsonValue = _elm_lang$core$Json_Encode$string(stringValue);
	return A2(_ohanhi$elm_native_ui$NativeUi$property, 'showHideTransition', jsonValue);
};
var _ohanhi$elm_native_ui$NativeUi_Properties$networkActivityIndicatorVisible = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'networkActivityIndicatorVisible',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$barStyle = function (val) {
	var stringValue = function () {
		var _p2 = val;
	...
	var jsonValue = _elm_lang$core$Json_Encode$string(stringValue);
	return A2(_ohanhi$elm_native_ui$NativeUi$property, 'barStyle', jsonValue);
};
var _ohanhi$elm_native_ui$NativeUi_Properties$translucent = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'translucent',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$animated = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'animated',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$hidden = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'hidden',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$scrollPerfTag = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'scrollPerfTag',
		_elm_lang$core$Json_Encode$string(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$zoomScale = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'zoomScale',
		_elm_lang$core$Json_Encode$float(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$removeClippedSubviews = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'removeClippedSubviews',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$snapToAlignment = function (val) {
	var stringValue = function () {
		var _p3 = val;
		switch (_p3.ctor) {
	...
	var jsonValue = _elm_lang$core$Json_Encode$string(stringValue);
	return A2(_ohanhi$elm_native_ui$NativeUi$property, 'snapToAlignment', jsonValue);
};
var _ohanhi$elm_native_ui$NativeUi_Properties$snapToInterval = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'snapToInterval',
		_elm_lang$core$Json_Encode$float(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$showsVerticalScrollIndicator = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'showsVerticalScrollIndicator',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$showsHorizontalScrollIndicator = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'showsHorizontalScrollIndicator',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$scrollsToTop = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'scrollsToTop',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$scrollEventThrottle = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'scrollEventThrottle',
		_elm_lang$core$Json_Encode$float(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$pagingEnabled = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'pagingEnabled',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$minimumZoomScale = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'minimumZoomScale',
		_elm_lang$core$Json_Encode$float(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$maximumZoomScale = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'maximumZoomScale',
		_elm_lang$core$Json_Encode$float(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$keyboardShouldPersistTaps = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'keyboardShouldPersistTaps',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$keyboardDismissMode = function (val) {
	var stringValue = function () {
		var _p4 = val;
		switch (_p4.ctor) {
	...
	var jsonValue = _elm_lang$core$Json_Encode$string(stringValue);
	return A2(_ohanhi$elm_native_ui$NativeUi$property, 'keyboardDismissMode', jsonValue);
};
var _ohanhi$elm_native_ui$NativeUi_Properties$canCancelContentTouches = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'canCancelContentTouches',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$directionalLockEnabled = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'directionalLockEnabled',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$indicatorStyle = function (val) {
	var stringValue = function () {
		var _p5 = val;
		switch (_p5.ctor) {
	...
	var jsonValue = _elm_lang$core$Json_Encode$string(stringValue);
	return A2(_ohanhi$elm_native_ui$NativeUi$property, 'indicatorStyle', jsonValue);
};
var _ohanhi$elm_native_ui$NativeUi_Properties$horizontal = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'horizontal',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$centerContent = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'centerContent',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$alwaysBounceVertical = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'alwaysBounceVertical',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$alwaysBounceHorizontal = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'alwaysBounceHorizontal',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$bouncesZoom = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'bouncesZoom',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$bounces = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'bounces',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$automaticallyAdjustContentInsets = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'automaticallyAdjustContentInsets',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$progressViewOffset = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'progressViewOffset',
		_elm_lang$core$Json_Encode$float(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$title = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'title',
		_elm_lang$core$Json_Encode$string(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$refreshing = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'refreshing',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$prompt = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'prompt',
		_elm_lang$core$Json_Encode$string(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$mode = function (val) {
	var stringValue = function () {
		var _p6 = val;
	...
	var jsonValue = _elm_lang$core$Json_Encode$string(stringValue);
	return A2(_ohanhi$elm_native_ui$NativeUi$property, 'mode', jsonValue);
};
var _ohanhi$elm_native_ui$NativeUi_Properties$enabled = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'enabled',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$active = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'active',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$minDelta = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'minDelta',
		_elm_lang$core$Json_Encode$float(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$maxDelta = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'maxDelta',
		_elm_lang$core$Json_Encode$float(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$scrollEnabled = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'scrollEnabled',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$pitchEnabled = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'pitchEnabled',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$rotateEnabled = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'rotateEnabled',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$zoomEnabled = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'zoomEnabled',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$showsCompass = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'showsCompass',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$showsPointsOfInterest = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'showsPointsOfInterest',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$followUserLocation = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'followUserLocation',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$showsUserLocation = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'showsUserLocation',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$defaultSourceUri = function (uri) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'defaultSource',
...
var _ohanhi$elm_native_ui$NativeUi_Properties$defaultSource = function (image) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'defaultSource',
		_elm_lang$core$Json_Encode$string(image));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$sourceUri = function (uri) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'source',
		_elm_lang$core$Json_Encode$object(
...
var _ohanhi$elm_native_ui$NativeUi_Properties$source = function (image) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'source',
		_elm_lang$core$Json_Encode$string(image));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$minimumFontScale = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'minimumFontScale',
		_elm_lang$core$Json_Encode$float(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$adjustsFontSizeToFit = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'adjustsFontSizeToFit',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$accessible = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'accessible',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$allowFontScaling = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'allowFontScaling',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$testID = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'testID',
		_elm_lang$core$Json_Encode$string(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$suppressHighlighting = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'suppressHighlighting',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$selectable = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'selectable',
		_elm_lang$core$Json_Encode$bool(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$numberOfLines = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'numberOfLines',
		_elm_lang$core$Json_Encode$float(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$ellipsizeMode = function (val) {
	var stringValue = function () {
		var _p7 = val;
		switch (_p7.ctor) {
	...
	var jsonValue = _elm_lang$core$Json_Encode$string(stringValue);
	return A2(_ohanhi$elm_native_ui$NativeUi$property, 'ellipsizeMode', jsonValue);
};
var _ohanhi$elm_native_ui$NativeUi_Properties$key = function (val) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi$property,
		'key',
		_elm_lang$core$Json_Encode$string(val));
};
var _ohanhi$elm_native_ui$NativeUi_Properties$TextEllipsizeModeClip = {ctor: 'TextEllipsizeModeClip'};
var _ohanhi$elm_native_ui$NativeUi_Properties$TextEllipsizeModeTail = {ctor: 'TextEllipsizeModeTail'};
var _ohanhi$elm_native_ui$NativeUi_Properties$TextEllipsizeModeMiddle = {ctor: 'TextEllipsizeModeMiddle'};
var _ohanhi$elm_native_ui$NativeUi_Properties$TextEllipsizeModeHead = {ctor: 'TextEllipsizeModeHead'};
var _ohanhi$elm_native_ui$NativeUi_Properties$PickerModeDropdown = {ctor: 'PickerModeDropdown'};
var _ohanhi$elm_native_ui$NativeUi_Properties$PickerModeDialog = {ctor: 'PickerModeDialog'};
var _ohanhi$elm_native_ui$NativeUi_Properties$ScrollViewIndicatorStyleWhite = {ctor: 'ScrollViewIndicatorStyleWhite'};
var _ohanhi$elm_native_ui$NativeUi_Properties$ScrollViewIndicatorStyleBlack = {ctor: 'ScrollViewIndicatorStyleBlack'};
var _ohanhi$elm_native_ui$NativeUi_Properties$ScrollViewIndicatorStyleDefault = {ctor: 'ScrollViewIndicatorStyleDefault'};
var _ohanhi$elm_native_ui$NativeUi_Properties$ScrollViewKeyboardDismissModeOnDrag = {ctor: 'ScrollViewKeyboardDismissModeOnDrag'};
var _ohanhi$elm_native_ui$NativeUi_Properties$ScrollViewKeyboardDismissModeInteractive = {ctor: 'ScrollViewKeyboardDismissModeInteractive'};
var _ohanhi$elm_native_ui$NativeUi_Properties$ScrollViewKeyboardDismissModeNone = {ctor: 'ScrollViewKeyboardDismissModeNone'};
var _ohanhi$elm_native_ui$NativeUi_Properties$ScrollViewSnapToAlignmentEnd = {ctor: 'ScrollViewSnapToAlignmentEnd'};
var _ohanhi$elm_native_ui$NativeUi_Properties$ScrollViewSnapToAlignmentCenter = {ctor: 'ScrollViewSnapToAlignmentCenter'};
var _ohanhi$elm_native_ui$NativeUi_Properties$ScrollViewSnapToAlignmentStart = {ctor: 'ScrollViewSnapToAlignmentStart'};
var _ohanhi$elm_native_ui$NativeUi_Properties$StatusBarBarStyleLightContent = {ctor: 'StatusBarBarStyleLightContent'};
var _ohanhi$elm_native_ui$NativeUi_Properties$StatusBarBarStyleDefault = {ctor: 'StatusBarBarStyleDefault'};
var _ohanhi$elm_native_ui$NativeUi_Properties$StatusBarShowHideTransitionSlide = {ctor: 'StatusBarShowHideTransitionSlide'};
var _ohanhi$elm_native_ui$NativeUi_Properties$StatusBarShowHideTransitionFade = {ctor: 'StatusBarShowHideTransitionFade'};
var _ohanhi$elm_native_ui$NativeUi_Properties$TabBarItemPositioningAuto = {ctor: 'TabBarItemPositioningAuto'};
			...
			_0: _ohanhi$elm_native_ui$NativeUi$style(
				{
					...
					_1: {
						ctor: '::',
						_0: _ohanhi$elm_native_ui$NativeUi_Style$backgroundColor('red'),
						_1: {
							ctor: '::',
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: _ohanhi$elm_native_ui$NativeUi$string(
						A2(_elm_lang$core$Basics_ops['++'], 'Error: ', err)),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
};
var _ohanhi$elm_native_ui$App_View$loadingView = A2(
	_ohanhi$elm_native_ui$NativeUi_Elements$view,
	{
		ctor: '::',
		_0: _ohanhi$elm_native_ui$NativeUi$style(
	...
	},
	{
		ctor: '::',
		_0: A2(
			_ohanhi$elm_native_ui$NativeUi_Elements$activityIndicator,
			{
				ctor: '::',
				_0: _ohanhi$elm_native_ui$NativeUi$style(
					{
...
var _ohanhi$elm_native_ui$App_View$footer = A2(
	_ohanhi$elm_native_ui$NativeUi_Elements$view,
	{
		...
		_0: _ohanhi$elm_native_ui$NativeUi$style(
			{
				ctor: '::',
				_0: _ohanhi$elm_native_ui$NativeUi_Style$backgroundColor('black'),
				_1: {
					ctor: '::',
					_0: _ohanhi$elm_native_ui$NativeUi_Style$flexDirection('column'),
					_1: {
						ctor: '::',
						_0: _ohanhi$elm_native_ui$NativeUi_Style$justifyContent('center'),
						_1: {
							ctor: '::',
							_0: _ohanhi$elm_native_ui$NativeUi_Style$height(45),
							_1: {ctor: '[]'}
						}
					}
				}
	...
	},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _ohanhi$elm_native_ui$NativeUi$string('Made with 🌳 and ❤ by @ajchambeaud'),
				_1: {ctor: '[]'}
			}),
		_1: {ctor: '[]'}
	});
var _ohanhi$elm_native_ui$App_View$header = function () {
	var imageSource = {
	...
	return A2(
		...
		},
		{
			ctor: '::',
			_0: A2(
				_ohanhi$elm_native_ui$NativeUi_Elements$image,
				{
					ctor: '::',
					_0: _ohanhi$elm_native_ui$NativeUi$style(
						{
							ctor: '::',
							_0: _ohanhi$elm_native_ui$NativeUi_Style$height(64),
							_1: {
								ctor: '::',
								_0: _ohanhi$elm_native_ui$NativeUi_Style$width(64),
								_1: {ctor: '[]'}
							}
						}),
					_1: {
						ctor: '::',
						_0: _ohanhi$elm_native_ui$NativeUi_Image$source(imageSource),
						_1: {ctor: '[]'}
					}
				},
				{ctor: '[]'}),
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _ohanhi$elm_native_ui$NativeUi$string('Elm Europe Schedule'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
...
var _ohanhi$elm_native_ui$App_View$talkHeader = function (talk) {
	var transformText = _elm_lang$core$Native_Utils.update(
		_ohanhi$elm_native_ui$NativeUi_Style$defaultTransform,
		{
			skewY: _elm_lang$core$Maybe$Just('5deg')
		});
	var transform = _elm_lang$core$Native_Utils.update(
		_ohanhi$elm_native_ui$NativeUi_Style$defaultTransform,
		{
			skewY: _elm_lang$core$Maybe$Just('-5deg'),
			translateY: _elm_lang$core$Maybe$Just(25)
		});
	var dateStr = A2(_justinmimbs$elm_date_extra$Date_Extra$toFormattedString, 'E, h:mm a', talk.start);
	return A2(
		_ohanhi$elm_native_ui$NativeUi_Elements$view,
		{
			ctor: '::',
			_0: _ohanhi$elm_native_ui$NativeUi$style(
				{
					ctor: '::',
					_0: _ohanhi$elm_native_ui$NativeUi_Style$alignItems('stretch'),
					_1: {
						ctor: '::',
						_0: _ohanhi$elm_native_ui$NativeUi_Style$backgroundColor('black'),
						_1: {ctor: '[]'}
			...
			_0: A2(
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _ohanhi$elm_native_ui$NativeUi_Style$transform(transform),
											_1: {ctor: '[]'}
										}
									}
								}
				...
				},
				{
					...
					_0: A2(
							...
							_0: _ohanhi$elm_native_ui$NativeUi$style(
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _ohanhi$elm_native_ui$NativeUi_Style$fontSize(18),
											_1: {
												ctor: '::',
												_0: _ohanhi$elm_native_ui$NativeUi_Style$paddingLeft(30),
												_1: {
													ctor: '::',
													_0: _ohanhi$elm_native_ui$NativeUi_Style$backgroundColor('transparent'),
													_1: {
														ctor: '::',
														_0: _ohanhi$elm_native_ui$NativeUi_Style$transform(
															_elm_lang$core$Native_Utils.update(
																transformText,
																{
																	translateY: _elm_lang$core$Maybe$Just(15)
																})),
														_1: {ctor: '[]'}
													}
												}
						...
						{
							ctor: '::',
							_0: _ohanhi$elm_native_ui$NativeUi$string(dateStr),
							_1: {ctor: '[]'}
						}),
					_1: {
						ctor: '::',
						_0: A2(
							_ohanhi$elm_native_ui$NativeUi_Elements$text,
							{
								...
								_0: _ohanhi$elm_native_ui$NativeUi$style(
									{
										ctor: '::',
										_0: _ohanhi$elm_native_ui$NativeUi_Style$color('#f0ad00'),
										_1: {
											ctor: '::',
											_0: _ohanhi$elm_native_ui$NativeUi_Style$textAlign('center'),
											_1: {
												ctor: '::',
												_0: _ohanhi$elm_native_ui$NativeUi_Style$fontSize(28),
												_1: {
													ctor: '::',
													_0: _ohanhi$elm_native_ui$NativeUi_Style$padding(30),
													_1: {
														ctor: '::',
														_0: _ohanhi$elm_native_ui$NativeUi_Style$backgroundColor('transparent'),
														_1: {
															ctor: '::',
															_0: _ohanhi$elm_native_ui$NativeUi_Style$transform(transformText),
															_1: {ctor: '[]'}
														}
													}
												}
							...
							{
								ctor: '::',
								_0: _ohanhi$elm_native_ui$NativeUi$string(talk.title),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _ohanhi$elm_native_ui$App_View$userView = function (speaker) {
	var imageUrl = A2(_elm_lang$core$String$dropLeft, 8, speaker.image);
	var imageSource = {
		uri: A2(
			_elm_lang$core$Basics_ops['++'],
			'https://images.weserv.nl/?url=',
			A2(_elm_lang$core$Basics_ops['++'], imageUrl, '&w=64&h=64')),
		cache: _elm_lang$core$Maybe$Just(_ohanhi$elm_native_ui$NativeUi_Image$ForceCache)
	};
	return A2(
		_ohanhi$elm_native_ui$NativeUi_Elements$view,
							...
							_1: {
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _ohanhi$elm_native_ui$NativeUi_Style$alignSelf('center'),
											_1: {
												ctor: '::',
												_0: _ohanhi$elm_native_ui$NativeUi_Style$width(_ohanhi$elm_native_ui$NativeApi_Dimensions$window.width / 1.5),
												_1: {ctor: '[]'}
											}
										}
									}
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _ohanhi$elm_native_ui$NativeUi$string(speaker.name),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
...
var _ohanhi$elm_native_ui$App_View$talkBody = function (talk) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi_Elements$view,
		{
			ctor: '::',
			...
			_0: A2(
				_ohanhi$elm_native_ui$NativeUi_Elements$text,
				{
					...
					_0: _ohanhi$elm_native_ui$NativeUi$style(
						{
							ctor: '::',
							_0: _ohanhi$elm_native_ui$NativeUi_Style$color('black'),
							_1: {
								ctor: '::',
								_0: _ohanhi$elm_native_ui$NativeUi_Style$textAlign('justify'),
								_1: {
									ctor: '::',
									_0: _ohanhi$elm_native_ui$NativeUi_Style$fontSize(12),
									_1: {
										ctor: '::',
										_0: _ohanhi$elm_native_ui$NativeUi_Style$padding(15),
										_1: {ctor: '[]'}
									}
								}
							}
				...
				{
					ctor: '::',
					_0: _ohanhi$elm_native_ui$NativeUi$string(talk.description),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _ohanhi$elm_native_ui$App_View$userView(talk.speaker),
				_1: {ctor: '[]'}
			}
		});
};
var _ohanhi$elm_native_ui$App_View$talkView = function (talk) {
	return A2(
		_ohanhi$elm_native_ui$NativeUi_Elements$view,
		{
			ctor: '::',
		...
		{
			ctor: '::',
			_0: _ohanhi$elm_native_ui$App_View$talkHeader(talk),
			_1: {
				ctor: '::',
				_0: _ohanhi$elm_native_ui$App_View$talkBody(talk),
				_1: {ctor: '[]'}
			}
		});
};
var _ohanhi$elm_native_ui$App_View$breakTimeView = function (item) {
	var transformChild = _elm_lang$core$Native_Utils.update(
		_ohanhi$elm_native_ui$NativeUi_Style$defaultTransform,
		{
			perspective: _elm_lang$core$Maybe$Just(_ohanhi$elm_native_ui$NativeApi_Dimensions$window.width),
			rotateY: _elm_lang$core$Maybe$Just('30deg')
		});
	var transform = _elm_lang$core$Native_Utils.update(
		_ohanhi$elm_native_ui$NativeUi_Style$defaultTransform,
		{
	...
	var dateStr = A2(_justinmimbs$elm_date_extra$Date_Extra$toFormattedString, 'E, h:mm a', item.start);
	return A2(
		_ohanhi$elm_native_ui$NativeUi_Elements$view,
		{
			ctor: '::',
					...
					_0: _ohanhi$elm_native_ui$NativeUi$style(
						{
							...
							_1: {
								ctor: '::',
								_0: _ohanhi$elm_native_ui$NativeUi_Style$backgroundColor('#f0ad00'),
								_1: {
									ctor: '::',
									_0: _ohanhi$elm_native_ui$NativeUi_Style$justifyContent('center'),
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _ohanhi$elm_native_ui$NativeUi_Style$transform(transformChild),
											_1: {ctor: '[]'}
										}
									}
								}
							...
							_0: _ohanhi$elm_native_ui$NativeUi$style(
								{
									...
									_1: {
										ctor: '::',
										_0: _ohanhi$elm_native_ui$NativeUi_Style$fontSize(20),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _ohanhi$elm_native_ui$NativeUi$string(item.title),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
...
var _ohanhi$elm_native_ui$App_View$activityView = function (activity) {
	var _p0 = activity;
	if (_p0.ctor === 'TalkActivity') {
		return _ohanhi$elm_native_ui$App_View$talkView(_p0._0);
	} else {
		return _ohanhi$elm_native_ui$App_View$breakTimeView(_p0._0);
	}
};
var _ohanhi$elm_native_ui$App_View$view = function (model) {
	var mainView = function () {
		var _p1 = model.activities;
		switch (_p1.ctor) {
			case 'Loading':
				return _ohanhi$elm_native_ui$App_View$loadingView;
			case 'Failure':
				return _ohanhi$elm_native_ui$App_View$errorView(
					_elm_lang$core$Basics$toString(_p1._0));
			case 'Success':
				return A2(
					_ohanhi$elm_native_ui$NativeUi_Elements$scrollView,
					{
						ctor: '::',
						_0: _ohanhi$elm_native_ui$NativeUi_Properties$horizontal(true),
						_1: {
							ctor: '::',
							_0: _ohanhi$elm_native_ui$NativeUi_Properties$pagingEnabled(true),
							_1: {ctor: '[]'}
						}
					},
					A2(
						_elm_lang$core$List$map,
						function (activity) {
							return _ohanhi$elm_native_ui$App_View$activityView(activity);
						},
						_p1._0));
			default:
				return _ohanhi$elm_native_ui$App_View$loadingView;
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _ohanhi$elm_native_ui$App_View$header,
			_1: {
				ctor: '::',
				_0: mainView,
				_1: {
					ctor: '::',
					_0: _ohanhi$elm_native_ui$App_View$footer,
					_1: {ctor: '[]'}
				}
			}
		});
...
var _ohanhi$elm_native_ui$Main$main = _ohanhi$elm_native_ui$NativeUi$program(
	{
		init: {ctor: '_Tuple2', _0: _ohanhi$elm_native_ui$App_State$model, _1: _ohanhi$elm_native_ui$App_Rest$getScheduleCmd},
		view: _ohanhi$elm_native_ui$App_View$view,
		update: _ohanhi$elm_native_ui$App_State$update,
